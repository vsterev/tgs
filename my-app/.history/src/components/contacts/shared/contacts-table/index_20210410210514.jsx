      ...
      <table>
        ...
        <tbody>
          {contacts.map((contact, i) => {
            if (type === 'departure') {
              contact.resId = contact.resId.toString();
              return (
                <tr key={contact.resId}>
                  ...
                  <td>
                    {!!contact.hasTransfer && (
                      <input
                        type="checkbox"
                        value={contact.resId.toString()}
                        checked={arrChecked.includes(contact.resId)}
                        onChange={(e) => {
                          console.log(typeof contact.resId, typeof arrChecked[0]);
                          if (!arrChecked.includes(e.target.value.toString())) {
                            setArrChecked([...arrChecked].concat(e.target.value.toString()));
                          } else {
