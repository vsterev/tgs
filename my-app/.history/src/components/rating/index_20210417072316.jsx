        ...
        <div>
          ...
          <form
            ...
            <TextField
              ...
              className={ratingStyles.textArea}
              className={ratingStyles.buttonRate}></TextField>
            />
            ...
            {err && <div>{err}</div>}
            <Button type="submit" fullWidth variant="contained" color="primary" className={ratingStyles.buttonRate}>
              Rate it
            </Button>
