...
const ContactsTable = ({ contacts, date, setContacts, type, setHotelId, setFlight, setHasTransfer }) => {
  ...
  return (
    <React.Fragment>
      {type === 'departure' && <h2>Изберете резервациите, за да определите час на вземане от хотела.</h2>}
      <table>
