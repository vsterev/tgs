      ...
      return fetch(service, {
        ...
        .then((result) => {
          ...
          const cacheGuid =
            result['soap:Envelope']['soap:Body'][0]['SearchHotelServicesResponse'][0]['SearchHotelServicesResult'][0][
              'Data'
            ][0]['DataRequestResult'][0]['ResponseGuid'][0];
          const totalCount =
            result['soap:Envelope']['soap:Body'][0]['SearchHotelServicesResponse'][0]['SearchHotelServicesResult'][0][
              'Data'
            ][0]['DataRequestResult'][0]['TotalCount'][0];
          const pageSize =
            result['soap:Envelope']['soap:Body'][0]['SearchHotelServicesResponse'][0]['SearchHotelServicesResult'][0][
              'Data'
            ][0]['DataRequestResult'][0]['PageSize'][0];
          const pageIndex =
            result['soap:Envelope']['soap:Body'][0]['SearchHotelServicesResponse'][0]['SearchHotelServicesResult'][0][
              'Data'
            ][0]['DataRequestResult'][0]['PageIndex'][0];
          const isLastPage =
            result['soap:Envelope']['soap:Body'][0]['SearchHotelServicesResponse'][0]['SearchHotelServicesResult'][0][
              'Data'
            ][0]['DataRequestResult'][0]['IsLastPage'][0];
