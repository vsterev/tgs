  ...
  return (
    <div className={styles.wrap}>
      ...
      <form onSubmit={formSubmit} className={classes.root}>
        ...
        <Button variant="outlined" size="medium" color="primary" type="submit" startIcon={<EditOutlinedIcon />}>
          edit Rep
        </Button>
        <Button variant="contained" size="medium" color="secondary" onClick={deleteRep} startIcon={<DeleteIcon />}>
          delete Rep
        </Button>
        {!!err && <div>{err}</div>}
      </form>
