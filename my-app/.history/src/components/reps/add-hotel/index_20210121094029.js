      ...
      {hotels.length !== 0 && (
        <div className={styles.formwrap}>
          <div className={styles.stickyButtton}>
            <Button variant="contained" color="default" onClick={history.goBack} startIcon={<ArrowBackIosIcon />}>
              back
            </Button>
            {/* <button onClick={history.goBack}>back</button> */}
          </div>
          ...
          <div className={styles.stickyButtton}>
            {/* <button type="submit">Add hotels</button> */}
            <Button variant="contained" color="default" color="primary" type="submit" startIcon={<SaveIcon />}>
              save changes
            </Button>
          </div>
        </div>
