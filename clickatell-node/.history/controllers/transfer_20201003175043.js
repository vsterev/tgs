...
module.exports = {
  ...
  post: {
    search: (req, res) => {
      ...
      console.log(checkOut, hotelId, flightDeparture);
      // const searchStr = {};
      // if (!!checkOut) {
      //   return (searchStr.checkOut = checkOut);
      // }
      // if (!!hotelId) {
      //   return (searchStr.hotelId = hotelId);
      // }
      // if (!!flightDeparture) {
      //   return (searchStr.flightDeparture = flightDeparture);
      // }
      // transferDepartureModel
      //   .find(searchStr)
      //   .then((res) => console.log(res))
