...
import PopupMessageArrivalCheck from './components/contacts/shared/arrival-check';
import PopupMessageDepartureCheck from './components/contacts/shared/departure-check';
import BulkSmsProfilePage from './components/pages/senders/bulkSms';
import ManualSmsPage from './components/pages/senders/manualSms';
...
import ThanksPage from './components/rating/thankyou';
import UserRatingError from './components/rating/share/error';
import HotelRating from './components/system/shared/hotel-rating';
const Navigation = () => {
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route path="/user-vote/error" component={UserRatingError} />
        <Route path="/user-vote/thanks" component={ThanksPage} />
        <Route path="/user-vote/:cryptedResId" component={UserRating} />
        ...
        />
        <Route path="/admin/hotel-rating/:hotelId" render={loggedIn ? () => <HotelRating /> : () => <LoginPage />} />
        ...
        <Route
          path="/admin/contacts/arrival/check/:date"
          exact
          render={loggedIn ? () => <PopupMessageArrivalCheck /> : () => <LoginPage />}
        />
        <Route
          path="/admin/contacts/departure/check/:date"
          exact
          render={loggedIn ? () => <PopupMessageDepartureCheck /> : () => <LoginPage />}
        />
        <Route exact path="/admin/contacts/arrival" render={loggedIn ? () => <ArrivalsPage /> : () => <LoginPage />} />
        <Route path="/admin/contacts/departure/" render={loggedIn ? () => <DeparturePage /> : () => <LoginPage />} />
        <Route path="/admin/bulk-sms/profile" render={loggedIn ? () => <BulkSmsProfilePage /> : () => <LoginPage />} />
        <Route path="/admin/bulk-sms/manual-send" render={loggedIn ? () => <ManualSmsPage /> : () => <LoginPage />} />
        <Route path="/admin/system" render={loggedIn ? () => <SystemComponentPage /> : () => <LoginPage />} />
