...
const ContactsTable = ({
  ...
  return (
    <React.Fragment>
      {type === 'departure' && <h3>Маркирайте резервациите за да определите часа на вземане на туритите от хотела</h3>}
      <table>
      ...
      {type === 'departure' && (
        <React.Fragment>
          ...
          <Chip variant="outlined" color="primary" avatar={<Avatar>+</Avatar>} onClick={selectAll} label="select all" />
        </React.Fragment>
      )}
    </React.Fragment>
  );
