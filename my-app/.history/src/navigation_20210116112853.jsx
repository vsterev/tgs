  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route path="/admin/login" render={!loggedIn ? () => <LoginPage /> : () => <RepsAll />} />
        <Route path="/admin/reps/all" render={loggedIn ? () => <RepsAll /> : () => <LoginPage />} />
        <Route path="/admin/reps/add-hotel/:repId" render={loggedIn ? () => <RepAddHotel /> : () => <LoginPage />} />
        <Route path="/admin/reps/add-rep" render={loggedIn ? () => <RepAdd /> : () => <LoginPage />} />
        ...
        <Route path="/admin/contacts/departure/" render={loggedIn ? () => <HomeContacts /> : () => <LoginPage />} />
        <Route path="/admin/contacts/arrival" render={loggedIn ? () => <ArrivalByDate /> : () => <LoginPage />} />
