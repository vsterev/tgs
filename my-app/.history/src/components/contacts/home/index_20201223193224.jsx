...
const HomeContacts = (props) => {
  ...
  const submitHandler = (e) => {
    ...
    contactsService
      ...
      .checkOut(setSearchCriteria, token)
      .then((result) => {
        setContacts(result);
        ...
        {contacts.length !== 0 && (
          <label htmlFor="hasTransfer">
            ...
            <select
              ...
              id="hasTransfer"
              onChange={(e) => {
                setSearchCriteria({ ...searchCriteria, setHasTransfer: e.target.value });
          ...
          <label htmlFor="flights">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setSearchCriteria({ ...searchCriteria, setFlight: e.target.value });
              }}>
              {flightsArr.map((fl, i) => {
                return (
