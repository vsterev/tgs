...
const SearchRep = ({ token, setReps, setErr, reps }) => {
  ...
  const searchRep = (e) => {
    ...
    const searched = [...reps].filter((a) => {
      // if (a.firstName.toLowerCase().includes(nameRep.toLowerCase())) {
      //   return true;
      // } else if (a.familyName.toLowerCase().includes(nameRep.toLowerCase())) {
      //   return true;
      // } else if ((a.firstName + ' ' + a.familyName).toLowerCase().includes(nameRep.toLowerCase())) {
      //   return true;
      // }
      if (a.resortId.name.toLowerCase().includes(resort.toLowerCase)) {
        return true;
      }
      // if (
      //   a.hotels.filter((b) => {
      //     // b.name.toLowerCase().includes(hotel.toLowerCase());
      //     return b.name.toLowerCase().includes(hotel.toLowerCase());
      //   })
      // ) {
      //   return true;
      // }
